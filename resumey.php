		...
		<div class="container mb-4 pb-4">
			<div class="row firstrow">
				...
				$imgname = $_FILES['photo']['name'];	
									...
									?>
					  <img src="<?php echo $im ?> " class="img-rounded p" alt="...">
					</div>
				...
				<a class="btn2" style="color: white;" href="information.php"><button class="btn-primary btn1">Back</button></a><br>
		<a href="#"><button class="btn-primary btn"	onclick="f();">
			print
		</button></a>
